...
public class UserRegistrationMain {
    ...
    private static final String PASSWORD_PATTERN_RULE_ONE = "^[a-zA-Z0-9]{8,}$";
    ...
    private static final String PASSWORD_PATTERN_RULE_FOUR = "(?=.*[@#$%!])(?=.*[a-z])(?=.*\\d)(?=.*[A-Z]).{8,40}";
    ...
    public boolean checkForValidPasswordByRuleFour(String password4) {
        return password4.matches(PASSWORD_PATTERN_RULE_FOUR);
    }
}
